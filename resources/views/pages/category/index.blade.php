    ...
    <div class="row">
        ...
        <div class="card w-100">
            ...
            <div class="d-flex justify-content-between mt-3 px-3">
                ...
                @endauth
                @guest
                    <a href="{{ route('login.handle') }}" class="btn btn-primary mb-3">Add Category</a>
                @endguest
            </div>
            <div class="card-body">
                            ...
                            @foreach ($categories as $category)
                                <tr scope="row">
                                    ...
                                    <td>
                                        ...
                                        @endauth
                                        @guest
                                            <a href="{{ route('login.handle') }}" class="btn btn-primary">Edit</a>
                                            <a href="{{ route('login.handle') }}" class="btn btn-danger">Delete</a>
                                        @endguest
                                    </td>
                                </tr>
                            @endforeach
